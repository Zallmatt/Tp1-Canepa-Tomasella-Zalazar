...
export class Manager{
    ...
    public generargrupo(){
        ...
        g0.AgregarEquipo(new Equipo("Qatar", "QR"));
        g0.AgregarEquipo(new Equipo("Ecuador", "EC"));
        g0.AgregarEquipo(new Equipo("Senegal", "SE"));
        g0.AgregarEquipo(new Equipo("Países Bajos", "PB"));
        g0.creacionAutomaticaPartidos();
        this.agregarGrupo(g0);
        
    
        const g1 = new Grupo("B");
        g1.AgregarEquipo(new Equipo("Inglaterra", "IN"));
        g1.AgregarEquipo(new Equipo("Iran", "IR"));
        g1.AgregarEquipo(new Equipo("Estados Unidos", "ES"));
        g1.AgregarEquipo(new Equipo("Ucrania", "UC"));
        g1.creacionAutomaticaPartidos();
        this.agregarGrupo(g1);
    
        const g2 = new Grupo("C");
        g2.AgregarEquipo(new Equipo("Argentina", "AR"));
        g2.AgregarEquipo(new Equipo("Mexico", "MX"));
        g2.AgregarEquipo(new Equipo("Arabia Saudita", "AS"));
        g2.AgregarEquipo(new Equipo("Polonia", "PO"));
        g2.creacionAutomaticaPartidos();
        this.agregarGrupo(g2);
    
        const g3 = new Grupo("D");
        g3.AgregarEquipo(new Equipo("Francia", "FR"));
        g3.AgregarEquipo(new Equipo("Peru", "PR"));
        g3.AgregarEquipo(new Equipo("Dinamarca", "DN"));
        g3.AgregarEquipo(new Equipo("Tunez", "TZ"));
        g3.creacionAutomaticaPartidos();
        this.agregarGrupo(g3);
    
        const g4 = new Grupo("E");
        g4.AgregarEquipo(new Equipo("España", "ES"));
        g4.AgregarEquipo(new Equipo("Costa Rica", "CR"));
        g4.AgregarEquipo(new Equipo("Alemania", "AL"));
        g4.AgregarEquipo(new Equipo("Japon", "JP"));
        g4.creacionAutomaticaPartidos();
        this.agregarGrupo(g4);
    
        const g5 = new Grupo("F");
        g5.AgregarEquipo(new Equipo("Belgica", "BG"));
        g5.AgregarEquipo(new Equipo("Canada", "CA"));
        g5.AgregarEquipo(new Equipo("Marruecos", "MR"));
        g5.AgregarEquipo(new Equipo("Croacia", "CO"));
        g5.creacionAutomaticaPartidos();
        this.agregarGrupo(g5);
    
        const g6 = new Grupo("G");
        g6.AgregarEquipo(new Equipo("Brasil", "BR"));
        g6.AgregarEquipo(new Equipo("Servia", "SE"));
        g6.AgregarEquipo(new Equipo("Suiza", "SA"));
        g6.AgregarEquipo(new Equipo("Camerun", "CN"));
        g6.creacionAutomaticaPartidos();
        this.agregarGrupo(g6);
    
        const g7 = new Grupo("H");
        g7.AgregarEquipo(new Equipo("Portugal", "PL"));
        g7.AgregarEquipo(new Equipo("Ghana", "GH"));
        g7.AgregarEquipo(new Equipo("Uruguay", "UY"));
        g7.AgregarEquipo(new Equipo("Corea del Sur", "CS"));
